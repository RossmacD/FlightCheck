...
const tmpDir = path.join(os.tmpdir(), `${CRATE_NAME}-cache-${packageVersion}`);
...
const REPO = 'RossmacD/FlightCheck';
...
module.exports = async opts => {
    ...
    const assetName = [`${CRATE_NAME}`, opts.version, opts.target].join('-') + extension;
